...
module.exports = __webpack_require__(/*! /home/mpoqq/Projects/hackathon/webapp/src/main.ts */"zUnb");
...
class MapComponent {
    constructor(chRef, restService) {
        ...
        this.options = {
            layers: [
                leaflet__WEBPACK_IMPORTED_MODULE_1__["tileLayer"]('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { maxZoom: 16, attribution: '...' })
            ],
            zoom: 14,
    ...
    mouseMv(e) {
        ...
        popup.addEventListener('click', (x) => {
            ...
            var restaurant;
            var parkingLots;
            this.restService.getDetails(parseInt(addressPoint.id)).subscribe((x) => {
                ...
                bars.forEach(bar => {
                    this.restService.getSpecificInfos(bar.nodeId).subscribe((x) => {
                        let res = '';
...
class RestService {
    ...
    getAllTiles() {
        ...
        const centerLat = 9.9876076;
          ...
          return of(tiles);*/
        return this.client.get('https://02bb1a4d2689.ngrok.io/api/tiles').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((tiles) => {
    ...
    reverseGeocode(coord) {
        return this.client.get(`https://api.opencagedata.com/geocode/v1/json?key=255440e4c59440e09a2c30126391b76a&q=${coord[0]},${coord[1]}&pretty=1`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((g) => {
