(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/animus/Projekte/hackathon/webapp/src/main.ts */
      "zUnb");
      /***/
    },
        ...
        _createClass(MapComponent, [{
          ...
          value: function onMapReady(map) {
            ...
            this.restService.tiles.subscribe(function (tiles) {
              ...
              _this2.heat = _this2.heat.addTo(map);
            });
          ...
          value: function mouseMv(e) {
            ...
            this.restService.getDetails([1, 2]).subscribe(function (x) {
              _this3.tooltipRef.nativeElement.innerHTML = "";
              var types = new Map();
              ...
              _this3.tooltipRef.nativeElement.innerHTML = "<b>Ø 3km</b><br>";
              types.forEach(function (val, key) {
                _this3.tooltipRef.nativeElement.innerHTML += "".concat(key, ": ").concat(val, "<br>");
              });
            });
            this.curRect = rect;
            this.layers = [];
            ...
            var popup = polygon.bindPopup("Infos");
            popup.addEventListener("click", function () {
              _this3.restService.getSpecificInfos().subscribe(function (x) {
                var res = "";
    ...
    function t7eW(module, __webpack_exports__, __webpack_require__) {
      ...
      var RestService = /*#__PURE__*/function () {
        ...
        _createClass(RestService, [{
          key: "getDetails",
          value: function getDetails(coords) {
          ...
          value: function getSpecificInfos() {
          ...
          value: function getAllTiles() {
            ...
            return this.client.get("https://e97cdbfd571e.ngrok.io/api/tiles").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (tiles) {
